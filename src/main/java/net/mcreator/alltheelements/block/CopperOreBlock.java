...
public class CopperOreBlock extends AllTheElementsModElements.ModElement {
	@ObjectHolder("all_the_elements:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(AllTheElementsModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Fusion Point : 1.085\u00BAC"));
		}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 8)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(15, 50, 50, 80))));
		}
	}
}
