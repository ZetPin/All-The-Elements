...
import net.mcreator.alltheelements.itemgroup.ATEMISCItemGroup;
import net.mcreator.alltheelements.AllTheElementsModElements;

import java.util.Random;

@AllTheElementsModElements.ModElement.Tag
public class PetrolBlock extends AllTheElementsModElements.ModElement {
	@ObjectHolder("all_the_elements:petrol")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("all_the_elements:petrol_bucket")
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing, FluidAttributes
				.builder(new ResourceLocation("all_the_elements:blocks/petrole_statique"), new ResourceLocation("all_the_elements:blocks/eau"))
				.luminosity(0).density(1000).viscosity(6000)).bucket(() -> bucket).block(() -> block);
		...
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ATEMISCItemGroup.tab))
