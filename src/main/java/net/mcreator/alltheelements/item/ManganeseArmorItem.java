...
public class ManganeseArmorItem extends AllTheElementsModElements.ModElement {

	@ObjectHolder("all_the_elements:manganese_armor_helmet")
	public static final Item helmet = null;

	@ObjectHolder("all_the_elements:manganese_armor_chestplate")
	public static final Item body = null;

	@ObjectHolder("all_the_elements:manganese_armor_leggings")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(ATEArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "all_the_elements:textures/models/armor/manganese_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
