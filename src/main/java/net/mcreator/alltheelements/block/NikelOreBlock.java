...
public class NikelOreBlock extends AllTheElementsModElements.ModElement {
	@ObjectHolder("all_the_elements:nikel_ore")
	public static final Block block = null;
	public NikelOreBlock(AllTheElementsModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Fusion Point : 1.455\u00BAC"));
		}
